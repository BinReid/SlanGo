...
async def main_menu_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if query.data == 'voice':
        await query.edit_message_text("🎤 Запишите ваше голосовое сообщение, если решите поменять вид обращения, напишите *назад*")
        return VOICE

    elif query.data == 'text':
        await query.edit_message_text("📝 Напишите ваше предложение, если решите поменять вид обращения, напишите *назад*")
        return TEXT
